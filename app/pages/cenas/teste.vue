...
<template>
    ...
    >
        ...
        <div
            class="flex flex-col gap-y-10 items-center pt-40 h-screen w-full md:py-0 bg-stone-50 border-2 border-black/5 relative"
        >
            <Brand class="size-12" />
            <!-- Username Animation -->
            <div class="flex items-center justify-center gap-0.5 pb-12">
                <h1
                    class="flex text-left text-stone-400 text-4xl md:text-4xl lg:text-5xl font-normal"
                >
                    liqo.app/
                </h1>
                <p
                    class="flex text-left text-black text-4xl md:text-4xl lg:text-5xl font-normal border-r-2 border-black pr-0.5 select-none w-fit"
                >
                    {{ currentText }}
                </p>
            </div>
